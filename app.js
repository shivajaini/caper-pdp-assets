...
const IMG = {
  ...
  map: "https://raw.githubusercontent.com/shivajaini/caper-pdp-assets/main/map.jpg",
  aisle: "https://raw.githubusercontent.com/shivajaini/caper-pdp-assets/main/aisle.jpg",
  shelf: "https://raw.githubusercontent.com/shivajaini/caper-pdp-assets/main/shelf.jpg",
};
...
function thumbRailHTML() {
  ...
  if (FLAGS.map) thumbs.push(`<button class="thumb" role="tab" data-media="map" ${sel("map")} aria-label="Store map">${mapIcon}</button>`);
  if (FLAGS.imagery) {
